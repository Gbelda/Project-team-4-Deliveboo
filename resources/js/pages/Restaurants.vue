<template>
  <div class="container">
    ...
    <div class="row justify-content-evenly">
      <div class="card col-3" style="width: 18rem" v-for="restaurant in restaurants" :key="restaurant.id">
        ...
        <div class="card-body">
          ...
          <small v-for="(category, index) in restaurant.categories" :key="restaurant.slug + category.id">
