                ...
                <div class="carousel-inner rounded-pill">
                    <div id="da_marco" class="carousel-item active">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-center">
                                <h2>da Marco</h2>
                                <h3>La migliore pizza d'Italia</h3>
                    ...
                    <div id="da_giovanni" class="carousel-item">
                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                <h2>Da Giovanni</h2>
                                <h3>Il miglior sushi di Milano</h3>
                    ...
                    <div id="da_laurentiu" class="carousel-item">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-center">
                                <h2>Da Laurentiu</h2>
                                <h3>Tutta la cucina orientale che vuoi</h3>
                                <button class="btn btn-sm" href="#">
                                    Provala subito
                                </button>
                            </div>
                    ...
                    <div id="da_giuseppe" class="carousel-item">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-center">
                                <h2>Da Giuseppe</h2>
                                <h3>La migliore cucina messicana di Milano</h3>
                                <button class="btn btn-sm" href="#">
                                    Provala subito
                                </button>
                            </div>
