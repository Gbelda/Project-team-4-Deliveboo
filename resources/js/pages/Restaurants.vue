    ...
    <div class="container-fluid jumbo p-0">
                    ...
                    <div id="da_marco" class="carousel-item active">
                        ...
                        <div class="container">
                            <div class="carousel-caption text-center">
                                ...
                                <router-link
                                    :to="'restaurants/da-marco'"
                                    class="btn btn-sm"
                                >
                                    Provala subito</router-link
                                >
                            </div>
                        </div>
                    </div>
                    <div id="da_giovanni" class="carousel-item">
                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                ...
                                <router-link
                                    :to="'restaurants/da-giovanni'"
                                    class="btn btn-sm"
                                >
                                    Provalo subito</router-link
                                >
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <section class="ristoranti_container">
                    <div class="content">
                        ...
                        <div
                            class="empty d-flex align-items-center justify-content-center text-danger"
                        >
                            <h3 v-if="restaurants == ''">
                        ...
                        <div
                            class="row justify-content-center contenitore_bordi rounded"
                        >
                            <div
        ...
        <section class="py-3" id="infografica">
            ...
            <div class="d-flex g-3 flex-wrap justify-content-center">
                ...
                <div
                    class="col-lg-4 d-flex flex-column align-items-center king"
                >
                    <h2>SOLO I MIGLIORI</h2>
                    <p>
