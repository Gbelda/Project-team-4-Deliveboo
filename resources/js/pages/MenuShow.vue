<template>
    <div class="">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="change_cart">
        ...
        <!-- <div class="hero_img"> -->
        <div>
            <div v-if="restaurant.slug == 'da-marco'">
                <img
                    class="img_hero"
                    src="/img/restaurants/ristorante_pizzeria.png"
                    alt="immagine degli interni del ristorante Da Marco"
                />
            </div>
            <div v-else-if="restaurant.slug == 'da-giovanni'">
                <img
                    class="img_hero"
                    src="/img/restaurants/ristorante_sushi.jpg"
                    alt="immagine degli interni del ristorante Da Giovanni"
                />
            </div>
            <div v-else-if="restaurant.slug == 'da-paolo'">
                <img
                    class="img_hero"
                    src="/img/restaurants/ristorante_americano.webp"
                    alt="immagine degli interni del ristorante Da Paolo"
                />
            </div>
            <div v-else-if="restaurant.slug == 'da-laurentiu'">
                <img
                    class="img_hero"
                    src="/img/restaurants/ristorante_cucina_orientale.jpg"
                    alt="immagine degli interni del ristorante Da Laurentiu"
                />
            </div>
            <div v-else-if="restaurant.slug == 'da-giuseppe'">
                <img
                    class="img_hero"
                    src="/img/restaurants/ristorante_messicano.jpg"
                    alt="immagine degli interni del ristorante Da Giuseppe"
                />
            </div>
            <div v-else>
                <img
                    class="img_hero"
                    src="/img/jumbo/menu_jumbo5.png"
                    alt="immagine artistica standard per i ristoranti"
                />
            </div>
        </div>
            ...
            <section class="plates row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-12">
                    ...
                    <div class="container_food row py-5 gy-5">
                        ...
                        >
                            <div
                                class="card_plates d-flex flex-column align-items-center text-center"
                            >
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <div class="sidebar-sticky carrello">
                        ...
                        <ul class="list-unstyled contenitore_piatti_carrello">
                            ...
                            >
                                <div
                                    class="name_qty d-flex justify-content-between"
                                >
                                    <h6>
                                        <strong>{{ value }}</strong>
                                    </h6>
                                ...
                                <div
                                    class="qty_plate d-flex justify-content-between"
                                >
                                    <div class="button">
                                        <button
                                            class="btn remove_btn"
                                            @click="removeToCart(value)"
                                        >
                                            <i class="fa-solid fa-minus"></i>
                                        </button>
                                        <button
                                            class="btn add_btn"
                                            @click="addQuantity(value)"
                                        >
...
export default {
    ...
    methods: {
        ...
        AddToCart(plate) {
            if (this.cart != "") {
                if (
                    this.cart[0]["user_id"] != plate["user_id"] &&
                    this.cart != 0
                ) {
