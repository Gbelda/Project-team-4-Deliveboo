...
<div class="mb-3">
    ...
    <input type="file" name="image" id="image" class="form-control" aria-describedby="imageHelper" accept="images/*">
...
<div class="mb-3">
    ...
    <input type="text"  name="ingredients" id="ingredients" class="form-control" placeholder="" aria-describedby="ingredientsHelper">
    <small id="ingredientsHelper" class="text-muted" value="{{old('ingredients')}}">Type a ingredients for your product</small>
    @error('ingredients')
<div class="alert alert-danger">{{ $message }}</div>
@enderror
</div>
<div class="mb-3">
    ...
    <input type="text"  name="price" id="price" class="form-control" placeholder="3.33" aria-describedby="priceHelper">
