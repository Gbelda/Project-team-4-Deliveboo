        ...
        <table class="table dash_container">
            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td><img width="100" src="{{ asset('/storage/' . $plate->image) }}" alt="{{$plate->name}}"></td>
                    <td>{{$plate->name}}</td>
                    <td>{{$plate->price}}</td>
                    <td >
                        <div class="d-flex flex-column">
                            <a class="btn show_btn" href="{{ route('admin.plates.show', $plate->id) }}"><i class="fas fa-eye"></i></a>
                            <a class="btn edit_btn" href="{{ route('admin.plates.edit', $plate->id) }}"><i class="fas fa-pencil-alt"></i></a>
